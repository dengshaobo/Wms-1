...
public class StocktakingActivity extends BaseActivity {
    ...
    private void initView() {
        ...
        adapter = new StocktakingAdapter(R.layout.activity_stocktaking_item, null);
        ...
        adapter.setOnItemClickListener((adapter1, view, position) -> {
            ...
            RxActivityTool.skipActivityForResult(this, StocktakingDetailsActivity.class, bundle, 1);
